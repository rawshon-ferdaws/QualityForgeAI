...
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Project Purpose**            | I am building **QualityForge AI**, an **AI-assisted QA automation framework** that combines traditional automated testing with LLM-powered QA capabilities. It covers **Selenium UI testing, REST API testing, backend/database validation, and end-to-end testing**, with AI assistance for **failure analysis, test scenario generation, test-data generation, and CI test-result summarization**. |
| **Purpose of Testing**         | I verify that the application works correctly across **UI, API, and backend layers**, catch defects early, validate critical user workflows, and support reliable releases through automated testing.                                                                                                                                                                                                |
| **UI Testing**                 | I use **Python, Selenium WebDriver, Pytest, and Page Object Model (POM)** to automate UI workflows such as login, products, cart, checkout, and end-to-end purchase flows.                                                                                                                                                                                                                           |
| **API Testing**                | I use **Python Requests + Pytest** for REST API automation, including GET, POST, PUT, PATCH, DELETE, query parameters, response validation, negative testing, and JSON Schema contract validation.                                                                                                                                                                                                   |
| **Backend / Database Testing** | I will use **SQL-based database validation** to verify backend data accuracy and consistency. **This is the next implementation layer.**                                                                                                                                                                                                                                                             |
| **AI-Assisted Testing**        | I integrated an **OpenAI GPT model through an API** into the framework for AI-assisted QA activities.                                                                                                                                                                                                                                                                                                |
| **Prompt Engineering**         | I designed **QA-specific structured prompts** for failure analysis, test generation, test-data generation, and CI test-result analysis.                                                                                                                                                                                                                                                              |
| **AI Failure Analysis**        | I use the LLM to analyze test failures and generate **probable root causes, failure categories, and recommended fixes**.                                                                                                                                                                                                                                                                             |
| **AI Test Generation**         | I use requirements as input to generate **positive, negative, boundary, and edge-case test scenarios**.                                                                                                                                                                                                                                                                                              |
| **AI Test-Data Generation**    | I use AI to generate **valid, invalid, boundary, and edge-case test data** based on requirements.                                                                                                                                                                                                                                                                                                    |
| **AI CI Summary**              | I use AI to transform automated test execution results into **QA/release summaries, risks, probable causes, and recommended actions**.                                                                                                                                                                                                                                                               |
| **Testing Strategies**         | I apply **functional, positive, negative, smoke, sanity, regression, risk-based, contract, integration, and end-to-end testing**, along with a **shift-left approach**.                                                                                                                                                                                                                              |
| **Test Data & Configuration**  | I use external **JSON test data**, `config.ini`, reusable utilities, and environment-based configuration.                                                                                                                                                                                                                                                                                            |
| **CI/CD**                      | I will integrate the framework with **GitHub Actions** for automated test execution.                                                                                                                                                                                                                                                                                                                 |
| **Docker**                     | I will containerize the framework to support consistent and reproducible execution environments.                                                                                                                                                                                                                                                                                                     |
| **Current Verified Results**   | **UI: 18/18 passed · API: 17/17 passed · AI: 5/5 passed**. Database, final CI/CD, Docker, and final full regression are still remaining.                                                                                                                                                                                                                                                             |
